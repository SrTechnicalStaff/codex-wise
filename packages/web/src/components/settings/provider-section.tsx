    ...
    <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            {embedderVars.length > 0 && (
              <p className="text-xs text-[var(--color-text-tertiary)]">
                ...
                — set <code className="font-mono">CODEX_WISE_EMBEDDER={embedder}</code> on the server.
              </p>
            )}
            {embedder === "mock" && (
              <p className="text-xs text-[var(--color-text-tertiary)]">
                Using mock embedder — semantic search disabled. Set{" "}
                <code className="font-mono">CODEX_WISE_EMBEDDER=gemini</code> or{" "}
                <code className="font-mono">CODEX_WISE_EMBEDDER=openai</code> for real RAG.
              </p>
            )}
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test that the local server is reachable and healthy.
          </CardDescription>
        </CardHeader>
