"""Embedder registry for codex_wise.
...
Custom embedder registration:
    from codex_wise.core.providers.embedding import register_embedder
...
_BUILTIN_EMBEDDERS: dict[str, tuple[str, str]] = {
    "openai": ("codex_wise.core.providers.embedding.openai", "OpenAIEmbedder"),
    "gemini":     ("codex_wise.core.providers.embedding.gemini",     "GeminiEmbedder"),
    "openrouter": ("codex_wise.core.providers.embedding.openrouter", "OpenRouterEmbedder"),
    "mock":       ("codex_wise.core.providers.embedding.base",       "MockEmbedder"),
}
