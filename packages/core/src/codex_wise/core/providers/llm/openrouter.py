"""OpenRouter provider for codex_wise.
...
class OpenRouterProvider(BaseProvider):
    ...
    Args:
        ...
        app_title:    App name shown on OpenRouter dashboard. Defaults to "Codex Wise".
        cost_tracker: Accepted for registry compatibility but not used — OpenRouter
                      proxies 200+ models with varying prices, so Codex Wise's fallback
