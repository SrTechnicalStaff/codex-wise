...
def get_env_value(name: str, default: str | None = None) -> str | None:
    """Read a Codex Wise environment variable."""
...
def resolve_llm_provider(
    ...
    *,
    ...
    cfg = config or {}
    configured_name = provider_name or get_env_value("CODEX_WISE_PROVIDER")
...
def _resolve_model(cfg: dict[str, Any]) -> str | None:
    return (
        get_env_value("CODEX_WISE_DOC_MODEL")
        or os.environ.get("CODEX_WISE_CODEX_MODEL")
        or get_env_value("CODEX_WISE_MODEL")
...
__all__ = ["ProviderResolution", "get_env_value", "resolve_llm_provider"]
