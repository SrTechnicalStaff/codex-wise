"""Base provider interface and response types for Codex Wise's LLM abstraction layer.

Codex Wise is model-agnostic by design. Any LLM — cloud or local — that implements
...
class BaseProvider(ABC):
    ...
    Codex Wise is model-agnostic. Any LLM that implements this interface
    ...
    async def generate(
        ...
        Args:
            ...
            temperature:   Sampling temperature. 0.0 is fully deterministic.
                           Codex Wise uses 0.3 for consistent doc style.
