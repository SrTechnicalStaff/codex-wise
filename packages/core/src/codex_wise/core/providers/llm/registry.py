"""Provider registry for codex_wise.
...
Custom provider registration:
    from codex_wise.core.providers import register_provider
...
_BUILTIN_PROVIDERS: dict[str, tuple[str, str]] = {
    ...
    "gemini": ("codex_wise.core.providers.llm.gemini", "GeminiProvider"),
    "ollama": ("codex_wise.core.providers.llm.ollama", "OllamaProvider"),
    "litellm": ("codex_wise.core.providers.llm.litellm", "LiteLLMProvider"),
    "mock": ("codex_wise.core.providers.llm.mock", "MockProvider"),
}
