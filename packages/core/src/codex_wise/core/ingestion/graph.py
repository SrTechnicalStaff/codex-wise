"""Dependency graph builder for the Codex Wise ingestion pipeline.
...
class GraphBuilder:
    ...
    def community_detection(self) -> dict[str, int]:
        ...
        from codex_wise.core.analysis.communities import detect_file_communities
    ...
    def symbol_communities(self) -> dict[str, int]:
        ...
        from codex_wise.core.analysis.communities import detect_symbol_communities
    ...
    def execution_flows(self, config: Any | None = None) -> Any:
        ...
        from codex_wise.core.analysis.execution_flows import (
            ExecutionFlowReport,
