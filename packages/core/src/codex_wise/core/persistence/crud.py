"""Async CRUD operations for the Codex Wise persistence layer.
...
async def upsert_page_from_generated(
    session: AsyncSession,
    generated_page: object,  # codex_wise.core.generation.models.GeneratedPage
    repository_id: str,
) -> Page:
...
async def recompute_git_percentiles(
    ...
    without a full ``codex-wise init``.  Returns the number of rows updated.
