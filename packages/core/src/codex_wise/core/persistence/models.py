"""SQLAlchemy ORM models for Codex Wise persistence layer.
...
codex_wise.core.ingestion.models.Symbol in files that import from both modules.
"""
...
class WikiSymbol(Base):
    ...
    codex_wise.core.ingestion.models.Symbol in files that import both.
    """
