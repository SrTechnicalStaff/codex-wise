...
from codex_wise.server.deps import get_db_session
from codex_wise.server.schemas import WebhookResponse

router = APIRouter(prefix="/api/webhooks", tags=["webhooks"])

_GITHUB_SECRET = os.environ.get("CODEX_WISE_GITHUB_WEBHOOK_SECRET", "")
_GITLAB_TOKEN = os.environ.get("CODEX_WISE_GITLAB_WEBHOOK_TOKEN", "")
...
def _launch_webhook_job(request: Request, job_id: str) -> None:
    ...
    from codex_wise.server.job_executor import execute_job
...
async def github_webhook(
    ...
    if event_type == "push":
        ...
        if ref.startswith("refs/heads/"):
            ...
            from codex_wise.core.persistence.models import Repository
