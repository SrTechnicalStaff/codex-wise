"""APScheduler background jobs for Codex Wise server.
...
def setup_scheduler(
    ...
    *,
    ...
    async def polling_fallback() -> None:
        ...
        from codex_wise.core.persistence.database import get_repo_storage_dir, get_session
        from codex_wise.core.persistence.models import GenerationJob, Repository
        ...
        try:
            async with get_session(session_factory) as session:
                ...
                for repo in repos:
                    ...
                    state_path = get_repo_storage_dir(repo.local_path) / "state.json"
                    stored_commit = None
