"""FastAPI dependency injection for the Codex Wise server.
...
_API_KEY = os.environ.get("CODEX_WISE_API_KEY")
_SERVER_HOST = os.environ.get("CODEX_WISE_HOST", "127.0.0.1")
...
if _API_KEY is None and _SERVER_HOST in ("0.0.0.0", "::"):
    logger.warning(
