...
async def get_why(
    ...
    if not query:
        from codex_wise.core.persistence.crud import get_decision_health_summary
    ...
    from codex_wise.core.persistence.crud import list_decisions as _list_decisions
