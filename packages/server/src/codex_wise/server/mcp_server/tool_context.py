...
# --- Output size budget -------------------------------------------------------
# Some MCP clients reject tool results whose stringified form exceeds
...
from codex_wise.server.mcp_server._meta import build_meta as _build_meta
from codex_wise.server.mcp_server._meta import context_hint as _context_hint
from codex_wise.server.mcp_server._server import mcp
            ...
            if meta:
                return {
                    ...
                    "error": (
                        ...
                        "the PageRank threshold. Run `codex-wise update` to regenerate docs."
                    ),
                    "exists_in_git": True,
